...
# distance hist bins=200

max(data$distances)


data.hist <- hist(data$distances, breaks=seq(0,5400,200), xaxt="n", main="Distances Between Palidromes", xlab="Distance from Last Palindrome", ylab="Count")
axis(side=1, at=seq(0, 5400, 600), las=2)
dev.copy(png,'graphs/scen2disthist.png')
dev.off()
